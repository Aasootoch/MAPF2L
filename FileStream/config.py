...
class Telegram:
    ...
    UPDATES_CHANNEL = str(env.get('UPDATES_CHANNEL', 'https://t.me/MAPOriginals'))  # Default to @MAPOriginals if not set
    ...
    FORCE_SUB = env.get('FORCE_UPDATES_CHANNEL', 'https://t.me/MAPOriginals' 'True')  # Default to 'False' if not set
